...
export class MeasurementFormComponent {
  ...
  patchMeasurementValues() {
    ...
    this.measurementForm.patchValue({
      ...
      skinfold: ({
        ...
        pectoral: this.measurement()?.skinfold?.pectoral,
        midaxillary: this.measurement()?.skinfold?.midaxillary,
  ...
  measurementForm = this.fb.group({
    ...
    skinfold: this.fb.group({
      ...
      pectoral: [0, [Validators.min(0)]],
      midaxillary: [0, [Validators.min(0)]],
  ...
  private formToMeasurement(): MeasurementRequest {
    ...
    const skinfold = Object.values(this.skinfoldControls).some(control => control.value) ? {
      ...
      pectoral: this.skinfoldControls.pectoral.value!,
      midaxillary: this.skinfoldControls.midaxillary.value!,
